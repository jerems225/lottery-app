...
class RechargementController extends AbstractController
{
    ...
    #[Route('/admin/usdt-deposits', name: 'admins.rechargements.usdt')]
    ...
    #[Route('/admin/usdt-deposits/{id}/status/{reference}/{status}', name: 'admins.rechargements.usdt.status')]
    /**
     *
     * @param TxUsdt $txUsdt
     * @param String $status
    ...
    #[Route('/admin/deposit-requests', name: 'admins.rechargements.req')]
    ...
    #[Route('/deposits/requests/{id}/status/{reference}/{status}', name: 'admins.rechargements.req.status')]
    /**
     *
     * @param TxReq $txReq
     * @param String $status
    ...
    #[Route('/recharger/{pseudo}/deposit-requests', name: 'user.rechargeur.rechargements.req')]
