...
{
    public function __construct(Environment $twig, withdrawalService $withdrawalService, walletService $walletService, betroomService $betroomService)
    {
        $this->twig = $twig;
        $this->withdrawalService = $withdrawalService;
        $this->walletService = $walletService;
        $this->betroomService = $betroomService;
    }

    #[Route('/admins/demandes-de-retraits', name:'admins.withdrawals')]
    ...
    #[Route('/admins/demandes-de-retraita/{id}status/{reference}/{status}',name:'admins.rechargements.withdrawal.status')]
    /**
     *
