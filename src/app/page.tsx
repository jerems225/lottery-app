             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-24">
                {((t("home", "features") || []) as { title: string, desc: string, icon: string }[]).map((f, i) => (
                  <div key={i} className="flex flex-col items-center md:items-start text-center md:text-left gap-6 group">
                    <div className="w-20 h-20 bg-white/5 border border-white/10 rounded-[32px] flex items-center justify-center text-primary-gold text-3xl group-hover:bg-primary-gold group-hover:text-white transition-all duration-500 shadow-2xl">
