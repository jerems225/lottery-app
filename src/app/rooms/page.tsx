      ...
      <main className="flex-1 py-20 px-6 lg:px-10 max-w-7xl mx-auto w-full relative overflow-hidden">
        ...
        {rooms.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {rooms.map(room => (
               <LotteryCard key={room.id} room={room} />
            ))}
          </div>
        )}
      </main>
            ...
            >
              ...
              <form onSubmit={handleCreateRoom} className="flex flex-col gap-6">
                ...
                <div className="p-4 bg-primary-gold/5 border border-primary-gold/10 rounded-2xl border-dashed">
                  <span className="text-[10px] font-black text-primary-gold uppercase mb-2 block tracking-widest">Pricing Rules</span>
                  ...
                  <div className="flex justify-between text-xs font-bold text-text-muted mt-1">
                    ...
                    <span className="text-primary-gold font-black">$80</span>
                  </div>
                </div>
